...
import com.technanosoft.www.gharse.Adapters.Vendor.Delevered_Orders
...
QueueOrders:Fragment() {


    private var listing_rec : RecyclerView? = null
    var posts: MutableList<Vendor_Orders?> = ArrayList()
    private lateinit var adapter: Delevered_Orders
    private var progress: ProgressBar? = null
    lateinit var manager: LinearLayoutManager
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater!!.inflate(R.layout.fragment_queue_orders, container, false)
        listing_rec = view.findViewById<View>(R.id.listing_delivered_orders) as RecyclerView
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = Delevered_Orders(posts)
    ...
    private fun GetOrder(){
        ...
        class SignUp : AsyncTask<Void, Void, String>() {
            ...
            override fun doInBackground(vararg voids: Void): String {
                ...
                return requestHandler.sendPostRequest(BuildConfig.Base_URL + "GetVendorDeliveredOrders", params)
            }
