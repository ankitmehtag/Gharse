...
class ListingAdapter_user(var data:MutableList<Recipe?>): RecyclerView.Adapter<RecipeViewHolder>(){
    ...
    override fun onBindViewHolder(p0: RecipeViewHolder, p1: Int) {
        ...
        Glide.with(p0.view.context).load("http://gharse.theposline.in/uploads/Recipe/"+Data?.RecipeImage).into(p0.Recipeimg)
        p0.RecipeDescription.text = Data.RecipeDescriptio
